...
//==============================================================================================================================================================================================
   ...
   //.........apple
    public static final DeferredHolder<Item, BlockItem> APPLE_CHEST_ITEM = FOODBLOCKITEM.register("apple_chest", () -> new BlockItem(foodblockregistry.APPLE_CHEST.get(), new BlockItem.Properties()));
}
