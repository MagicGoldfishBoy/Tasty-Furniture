...
public class GM1BlockStateProvider extends BlockStateProvider 
{
    ...
    //---------------------------------------------------------------desks-------------------------------------------------------------------------------
        ...
        //.............chorus
         foodDesk chorusDesk = foodblockregistry.CHORUS_DESK.get();
         
         getVariantBuilder(chorusDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/chorus_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/chorus_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/chorus_desk_double_left");
             } else {
                modelLocation = modLoc("block/chorus_desk_double_right");
             }
        ...
        //.............glowberry
         foodDesk glowberryDesk = foodblockregistry.GLOWBERRY_DESK.get();
         
         getVariantBuilder(glowberryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/glowberry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/glowberry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/glowberry_desk_double_left");
             } else {
                modelLocation = modLoc("block/glowberry_desk_double_right");
             }
        ...
        //.............melon
         foodDesk melonDesk = foodblockregistry.MELON_DESK.get();
         
         getVariantBuilder(melonDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/melon_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/melon_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/melon_desk_double_left");
             } else {
                modelLocation = modLoc("block/melon_desk_double_right");
             }
        ...
        //.............sweetberry
         foodDesk sweetberryDesk = foodblockregistry.SWEETBERRY_DESK.get();
         
         getVariantBuilder(sweetberryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/sweetberry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/sweetberry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/sweetberry_desk_double_left");
             } else {
                modelLocation = modLoc("block/sweetberry_desk_double_right");
             }
        ...
        //.............brownmushroom
         foodDesk brownmushroomDesk = foodblockregistry.BROWNMUSHROOM_DESK.get();
         
         getVariantBuilder(brownmushroomDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/brownmushroom_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/brownmushroom_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/brownmushroom_desk_double_left");
             } else {
                modelLocation = modLoc("block/brownmushroom_desk_double_right");
             }
        ...
        //.............redmushroom
         foodDesk redmushroomDesk = foodblockregistry.REDMUSHROOM_DESK.get();
         
         getVariantBuilder(redmushroomDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/redmushroom_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/redmushroom_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/redmushroom_desk_double_left");
             } else {
                modelLocation = modLoc("block/redmushroom_desk_double_right");
             }
        ...
        //.............pumpkin
         foodDesk pumpkinDesk = foodblockregistry.PUMPKIN_DESK.get();
         
         getVariantBuilder(pumpkinDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/pumpkin_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/pumpkin_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/pumpkin_desk_double_left");
             } else {
                modelLocation = modLoc("block/pumpkin_desk_double_right");
             }
        ...
        //.............chicken
         foodDesk chickenDesk = foodblockregistry.CHICKEN_DESK.get();
         
         getVariantBuilder(chickenDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/chicken_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/chicken_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/chicken_desk_double_left");
             } else {
                modelLocation = modLoc("block/chicken_desk_double_right");
             }
        ...
        //.............cod
         foodDesk codDesk = foodblockregistry.COD_DESK.get();
         
         getVariantBuilder(codDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/cod_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/cod_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/cod_desk_double_left");
             } else {
                modelLocation = modLoc("block/cod_desk_double_right");
             }
        ...
        //.............salmon
         foodDesk salmonDesk = foodblockregistry.SALMON_DESK.get();
         
         getVariantBuilder(salmonDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/salmon_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/salmon_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/salmon_desk_double_left");
             } else {
                modelLocation = modLoc("block/salmon_desk_double_right");
             }
        ...
        //.............tropicalfish
         foodDesk tropicalfishDesk = foodblockregistry.TROPICALFISH_DESK.get();
         
         getVariantBuilder(tropicalfishDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/tropicalfish_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/tropicalfish_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/tropicalfish_desk_double_left");
             } else {
                modelLocation = modLoc("block/tropicalfish_desk_double_right");
             }
        ...
        //.............mutton
         foodDesk muttonDesk = foodblockregistry.MUTTON_DESK.get();
         
         getVariantBuilder(muttonDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/mutton_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/mutton_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/mutton_desk_double_left");
             } else {
                modelLocation = modLoc("block/mutton_desk_double_right");
             }
        ...
        //.............pork
         ...
         .forAllStates(state -> {
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/pork_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/pork_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/pork_desk_double_left");
             } else {
                modelLocation = modLoc("block/pork_desk_double_right");
             }
        ...
        //.............rabbit
         foodDesk rabbitDesk = foodblockregistry.RABBIT_DESK.get();
         
         getVariantBuilder(rabbitDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/rabbit_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/rabbit_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/rabbit_desk_double_left");
             } else {
                modelLocation = modLoc("block/rabbit_desk_double_right");
             }
        ...
        //.............sugar
         foodDesk sugarDesk = foodblockregistry.SUGAR_DESK.get();
         
         getVariantBuilder(sugarDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/sugar_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/sugar_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/sugar_desk_double_left");
             } else {
                modelLocation = modLoc("block/sugar_desk_double_right");
             }
        ...
        //.............honeycomb
         foodDesk honeycombDesk = foodblockregistry.HONEYCOMB_DESK.get();
         
         getVariantBuilder(honeycombDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDesk.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDesk.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/honeycomb_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/honeycomb_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/honeycomb_desk_double_left");
             } else {
                modelLocation = modLoc("block/honeycomb_desk_double_right");
             }
    ...
    //--------------------------------------------------------------desk lamps------------------------------------------------------------------------------
     ...
     //.............potato
        foodDeskLamp potato_desk_lamp = foodblockregistry.POTATO_DESKLAMP.get();

        getVariantBuilder(potato_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/potato_lamp_lit") : modLoc("block/potato_lamp_unlit");
     ...
     //.............beetroot
        foodDeskLamp beetroot_desk_lamp = foodblockregistry.BEETROOT_DESKLAMP.get();

        getVariantBuilder(beetroot_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/beetroot_lamp_lit") : modLoc("block/beetroot_lamp_unlit");
     ...
     //.............glowberry
        foodDeskLamp glowberry_desk_lamp = foodblockregistry.GLOWBERRY_DESKLAMP.get();

        getVariantBuilder(glowberry_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/glowberry_lamp_lit") : modLoc("block/glowberry_lamp_unlit");
     ...
     //.............melon
        foodDeskLamp melon_desk_lamp = foodblockregistry.MELON_DESKLAMP.get();

        getVariantBuilder(melon_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/melon_lamp_lit") : modLoc("block/melon_lamp_unlit");
     ...
     //.............sweetberry
        foodDeskLamp sweetberry_desk_lamp = foodblockregistry.SWEETBERRY_DESKLAMP.get();

        getVariantBuilder(sweetberry_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/sweetberry_lamp_lit") : modLoc("block/sweetberry_lamp_unlit");
     ...
     //.............brownmushroom
        foodDeskLamp brownmushroom_desk_lamp = foodblockregistry.BROWNMUSHROOM_DESKLAMP.get();

        getVariantBuilder(brownmushroom_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/brownmushroom_lamp_lit") : modLoc("block/brownmushroom_lamp_unlit");
     ...
     //.............redmushroom
        foodDeskLamp redmushroom_desk_lamp = foodblockregistry.REDMUSHROOM_DESKLAMP.get();

        getVariantBuilder(redmushroom_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/redmushroom_lamp_lit") : modLoc("block/redmushroom_lamp_unlit");
     ...
     //.............pumpkin
        foodDeskLamp pumpkin_desk_lamp = foodblockregistry.PUMPKIN_DESKLAMP.get();

        getVariantBuilder(pumpkin_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/pumpkin_lamp_lit") : modLoc("block/pumpkin_lamp_unlit");
     ...
     //.............chicken
        foodDeskLamp chicken_desk_lamp = foodblockregistry.CHICKEN_DESKLAMP.get();

        getVariantBuilder(chicken_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/chicken_lamp_lit") : modLoc("block/chicken_lamp_unlit");
     ...
     //.............cod
        foodDeskLamp cod_desk_lamp = foodblockregistry.COD_DESKLAMP.get();

        getVariantBuilder(cod_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/cod_lamp_lit") : modLoc("block/cod_lamp_unlit");
     ...
     //.............salmon
        foodDeskLamp salmon_desk_lamp = foodblockregistry.SALMON_DESKLAMP.get();

        getVariantBuilder(salmon_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/salmon_lamp_lit") : modLoc("block/salmon_lamp_unlit");
     ...
     //.............tropicalfish
        foodDeskLamp tropicalfish_desk_lamp = foodblockregistry.TROPICALFISH_DESKLAMP.get();

        getVariantBuilder(tropicalfish_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/tropicalfish_lamp_lit") : modLoc("block/tropicalfish_lamp_unlit");
     ...
     //.............beef
        foodDeskLamp beef_desk_lamp = foodblockregistry.BEEF_DESKLAMP.get();

        getVariantBuilder(beef_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/beef_lamp_lit") : modLoc("block/beef_lamp_unlit");
     ...
     //.............pork
        foodDeskLamp pork_desk_lamp = foodblockregistry.PORK_DESKLAMP.get();

        getVariantBuilder(pork_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/pork_lamp_lit") : modLoc("block/pork_lamp_unlit");
     ...
     //.............rabbit
        foodDeskLamp rabbit_desk_lamp = foodblockregistry.RABBIT_DESKLAMP.get();

        getVariantBuilder(rabbit_desk_lamp)
            .forAllStates(state -> {
                Boolean lit = state.getValue(BlockStateProperties.LIT);
                Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                int rotation = switch (facing) {
                ...
                ResourceLocation modelLocation = lit ? modLoc("block/rabbit_lamp_lit") : modLoc("block/rabbit_lamp_unlit");
