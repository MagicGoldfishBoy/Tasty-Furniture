...
public class redmushroomBarrelEntity extends BarrelBlockEntity {

    public redmushroomBarrelEntity(BlockPos pPos, BlockState pBlockState) {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            redmushroomBarrelEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
            redmushroomBarrelEntity.this.updateBlockState(p_155064_, true);
        }

        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            redmushroomBarrelEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
            redmushroomBarrelEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == redmushroomBarrelEntity.this;
            } else {
                return false;
            }
        }
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.redmushroomBarrel");
    }
